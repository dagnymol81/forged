  ...
  return(
    <div>
      ...
      <ul>
        ...
        <li><strong>Stealth: </strong><em>entry point</em></li>
        <li><strong>Occult: </strong><em>arcane power</em></li>
        <li><strong>Social: </strong><em>connection</em></li>
        <li><strong>Transport: </strong><em>route</em></li>
      </ul>
    </div>
  )
}